# ES08 — VPN: Configurazione di Tunnel VPN con Router Cisco

> **Materia**: Sistemi e Reti — Classe 4ª/5ª  
...
| 5 | [`docs/04_VPN_Troubleshooting.md`](docs/04_VPN_Troubleshooting.md) | Troubleshooting VPN: verifica stato, debug, soluzioni | 🛠️ Quando qualcosa non funziona |
