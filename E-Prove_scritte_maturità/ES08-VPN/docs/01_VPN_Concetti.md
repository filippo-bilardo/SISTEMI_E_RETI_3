...
> Leggi questa guida prima di iniziare l'Esercizio A.
...
- **Anni '90**: le aziende usavano linee dedicate (leased line) costose per collegare sedi
- **1996**: Microsoft sviluppa PPTP, il primo protocollo VPN diffuso
- **1999**: IPsec diventa standard (RFC 2401); nasce OpenVPN poco dopo
- **Anni 2000**: SSL VPN si diffonde con l'esplosione del telelavoro
- **2019**: WireGuard viene integrato nel kernel Linux — rivoluzione nella semplicità VPN
- **Oggi**: VPN usate da miliardi di persone (sia aziendali che consumer)
